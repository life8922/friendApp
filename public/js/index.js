$(function(){
  $.ajax({
    ...
    success:function(res){
      ...
      <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="http://upload.chinaz.com/2018/0111/6365126280959981105917510.png" style="height:280px;width:250px" data-holder-rendered="true">`;//删除html中57~65行
      ...
      <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="http://upload.chinaz.com/2018/0111/6365126280959981105917510.png" data-holder-rendered="true" style="height:230px;width:217px">`;//删除61~69行
      var divCard=
      ...
      <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="http://img011.hc360.cn/hb/MTQ2MTY4Mjg4MzgxMjEwMDgyNzgwMA==.jpg" data-holder-rendered="true">`;//删除67~72行
      var divCard=document.querySelector(
      ...
      for(var p of res.slice(3)){
        ...
        html+=`<div class="col-md-4 p-0 pl-2">
          <div class="card border-0 text-center">
            <img class="card-img-top" src="http://img19.3lian.com/d/file/201801/06/cf1fd0eeb0587c1fb70782d3326bed65.png" style="height:135px" alt="Card image cap">
